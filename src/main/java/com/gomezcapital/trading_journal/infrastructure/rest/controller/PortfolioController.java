...
public class PortfolioController {
    ...
    public ResponseEntity<Portfolio> updateTargetBalance(
            ...
            Authentication authentication) { // <-- Leemos el token
        return ResponseEntity.ok(portfolioService.updateTargetBalance(id, request.targetBalance(), authentication.getName()));
    }
