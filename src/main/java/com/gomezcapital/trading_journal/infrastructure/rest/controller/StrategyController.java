...
public class StrategyController {
    ...
    @PostMapping
    public ResponseEntity<StrategyResponse> createStrategy(@RequestBody CreateStrategyRequest request, Authentication authentication) {
        // <-- ESCUDO ACTIVADO -->
    ...
    public ResponseEntity<List<StrategyResponse>> getStrategiesByAccount(@PathVariable UUID portfolioId, Authentication authentication) {
        // <-- ESCUDO ACTIVADO -->
